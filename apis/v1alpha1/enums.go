...
const (
	PlacementConstraintType_DISTINCT_INSTANCE PlacementConstraintType = "DISTINCT_INSTANCE"
	PlacementConstraintType_MEMBER_OF         PlacementConstraintType = "MEMBER_OF"
)
