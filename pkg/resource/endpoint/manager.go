...
// +kubebuilder:rbac:groups=eventbridge.services.k8s.aws,resources=endpoints,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=eventbridge.services.k8s.aws,resources=endpoints/status,verbs=get;update;patch
