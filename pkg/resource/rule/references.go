...
func (rm *resourceManager) ResolveReferences(
	...
	if err == nil {
		err = resolveReferenceForEventBusName(ctx, apiReader, namespace, ko)
	}
...
// resource
func hasNonNilReferences(ko *svcapitypes.Rule) bool {
	return false || (ko.Spec.EventBusRef != nil)
}

// resolveReferenceForEventBusName reads the resource referenced
// from EventBusRef field and sets the EventBusName
// from referenced resource
func resolveReferenceForEventBusName(
	ctx context.Context,
	apiReader client.Reader,
	namespace string,
	ko *svcapitypes.Rule,
	...
	if ko.Spec.EventBusRef != nil && ko.Spec.EventBusRef.From != nil {
		...
		if arr == nil || arr.Name == nil || *arr.Name == "" {
			return fmt.Errorf("provided resource reference is nil or empty: EventBusRef")
		}
