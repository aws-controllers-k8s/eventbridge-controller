...
const (
	FinalizerString = "finalizers.eventbridge.services.k8s.aws/EventBus"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("eventbuses")
