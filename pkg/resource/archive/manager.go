...
// +kubebuilder:rbac:groups=eventbridge.services.k8s.aws,resources=archives,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=eventbridge.services.k8s.aws,resources=archives/status,verbs=get;update;patch
