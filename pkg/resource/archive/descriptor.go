...
const (
	FinalizerString = "finalizers.eventbridge.services.k8s.aws/Archive"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("archives")
